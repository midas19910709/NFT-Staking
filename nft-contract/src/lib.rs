...
use near_sdk::{
    assert_one_yocto, env, ext_contract, near_bindgen, AccountId, Balance, CryptoHash, Gas, PanicOnDefault, Promise, PromiseOrValue, BorshStorageKey,
};
...
/// This spec can be treated like a version of the NFT standard.
