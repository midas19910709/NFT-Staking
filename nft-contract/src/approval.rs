...
pub trait NonFungibleTokenApproval {
    ...
    fn nft_auction_approve(&mut self, token_id: TokenId, account_id: AccountId, msg: Option<String>);
...
impl NonFungibleTokenApproval for Contract {
    ...
    fn nft_auction_approve(&mut self, token_id: TokenId, account_id: AccountId, msg: Option<String>) {
        ...
        if let Some(msg) = msg {
            ext_non_fungible_approval_receiver::nft_auction_on_approve(
                token_id, 
                token.owner_id, 
                approval_id, 
                msg, 
